            ...
            <div className="row justify-content-center" >
                <div className="col-md-8">
                    <div className="d-flex justify-content-md-center align-items-center vh-100">
                        <div style={{float:"right" , color:"black", backgroundColor:"white", padding:"40px", borderRadius:"10px"}}>
                            ...
                            <form noValidate onSubmit={fromHandler}>
                                ...
                                {!isLoading && <button type="submit" className="btn btn-info btn-block" style={{backgroundColor:"#003b67"}}>Login</button>}
                            </form>
                        </div>
                    </div>
                </div>
