                ...
                {store.faculty.fetchedStudentsHelper && <div className="row justify-content-center mt-4 ">
                    <div className="col-md-4" style={{marginTop:"70px"}}>
                        <form noValidate onSubmit={formHandler}>
                            ...
                            {!isLoading && <button type="submit" style={{backgroundColor:"#003b67"}} className="btn btn-info  ">Search</button>}
                        </form>
                    </div>
                </div>}
                ...
                {!store.faculty.fetchedStudentsHelper && <div className="row  justify-content-center mt-4">
                    <div className="col-md-4" style={{marginTop:"50px"}}>
                        <form onSubmit={secondFormHandler}>
                            ...
                            {!isLoading2 && <button type="submit" style={{backgroundColor:"#003b67", color:"white"}} className="btn  ml-1  ">Submit</button>}
                        </form>
                    </div>
                </div>
                }</> : (history.push('/'))}
