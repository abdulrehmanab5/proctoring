...
import { fetchStudents, uploadPaper } from '../../redux/action/facultyAction'
...
const FacultyUploadPapers = () => {
    ...
    const secondFormHandler = (e) => {
        e.preventDefault()
        dispatch(uploadPaper(subjectCode, exam, totalMarks, marks, department, section
        ))
    }
                ...
                {store.faculty.fetchedStudentsHelper && <div className="row justify-content-center mt-4 ">
                    <div className="col-md-4">
                        <form noValidate onSubmit={formHandler}>
                            ...
                            <button type="submit" className="btn btn-primary" style={{backgroundColor:"#003b67"}}>Search</button>
                        </form>
                    </div>
                </div>}
                ...
                {!store.faculty.fetchedStudentsHelper && <div className="row  justify-content-center mt-4">
                    <div className="col-md-4">
                        <form onSubmit={secondFormHandler}>
                            <div className="form-group" style={{marginTop:"85px"}}>
                            ...
                            <button type="submit" className="btn btn-primary ml-1" style={{backgroundColor:"#003b67"}}>Submit</button>
                        </form>
                    </div>
                </div>
                }
