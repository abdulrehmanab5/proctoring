                        ...
                        <div className="col-md-8 m-auto border" style={{ backgroundColor: "white", borderRadius: "1.2rem", padding: "1rem 1rem 0rem 1rem" }}>
                            <div>
                                ...
                                <form noValidate onSubmit={facultyFormHandler}>
                                    ...
                                    {!isFacultyLoading && <button type="submit" className="btn btn-info btn-block" style={{backgroundColor:"#003b67"}}>Login</button>}
                                </form>
                                <p className="text-center mt-2 "><Link className="text-center" to="/forgotPassword/faculty" style={{color:"#003b67"}}>Forgot Password</Link></p>
                            </div>
                        </div>
                    </div>
                    <div className="row m-5">
                        <div className="col-md-8 m-auto border" style={{ backgroundColor: "white", borderRadius: "1.2rem", padding: "1rem 1rem 0rem 1rem" }}>
                            <div>
                                ...
                                <form noValidate onSubmit={studentFormHandler}>
                                    ...
                                    {!isStudentLoading && 
                                    <button type="submit" className="btn btn-info btn-block" style={{backgroundColor:"#003b67"}}>Login</button>}

                                </form>
                                <p className="text-center" ><Link className="text-center" to="/forgotPassword/student" style={{color:"#003b67"}}>Forgot Password</Link></p>
                            </div>
                        </div>
                    </div>
                </div>
