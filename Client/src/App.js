...
import FacultyUploadPaper from './Pages/Faculty/FacultyUploadPaper'
    ...
    <div>
      <Router>
        <Switch>
          ...
          <Route exact path="/Servicepre" component={Homepre} />
          ...
          <Route exact path="/faculty/uploadPaper" component={FacultyUploadPaper} />
